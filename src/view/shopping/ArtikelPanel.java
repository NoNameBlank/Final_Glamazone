...
public class ArtikelPanel extends JPanel {
	...
	public ArtikelPanel() {
		...
		//Wurde jetzt Lokal im Konstruktor erstellt da keine wirkliche Aufgabe, sonder Bezeichnet nur ein anderes Label
	...
	public ArtikelPanel(String artikelName, String bild, String productDescription, String price) {
		this();
